...
a_Goto_SetupAPU2:
			jmp a_SetupAPU2			; $8004: 4c e8 86

;-------------------------------------------------------------------------------
a_Goto_SetupAPU:
			jmp a_SetupAPU			; $8007: 4c ef 86

;-------------------------------------------------------------------------------
a_Goto_PlaySound:
			jmp a_PlaySound			; $800a: 4c 2d 87

;-------------------------------------------------------------------------------
			jmp a_8019			; $800d: 4c 19 80

;-------------------------------------------------------------------------------
			jmp a_8900			; $8010: 4c 00 89

;-------------------------------------------------------------------------------
			jmp a_8905			; $8013: 4c 05 89

;-------------------------------------------------------------------------------
a_Goto_MusicFadeOut:
			jmp a_Sub_MusicFadeOut			; $8016: 4c 64 8b

;-------------------------------------------------------------------------------

a_8019:		lda $030f			; $8019: ad 0f 03
			beq a_801f			; $801c: f0 01
			rts				; $801e: 60

;-------------------------------------------------------------------------------
a_801f:		lda $d6			; $801f: a5 d6
			and #$fe				; $8021: 29 fe
			cmp $d6			; $8023: c5 d6
			sta $d6			; $8025: 85 d6
			beq a_803d			; $8027: f0 14
			lda #$00				; $8029: a9 00
			jsr a_SetupPitchVolume			; $802b: 20 45 87
			ldx #$00				; $802e: a2 00
...
a_803d:		jsr a_8665			; $803d: 20 65 86
			ldy #$00				; $8040: a0 00
			lda $d6			; $8042: a5 d6
			and #$02				; $8044: 29 02
...
a_8050:		ldx $030b			; $8050: ae 0b 03
			lda $031c,x		; $8053: bd 1c 03
			bne a_805b			; $8056: d0 03
			jmp a_8103			; $8058: 4c 03 81
...
a_805b:		tay				; $805b: a8
			...
			bcc a_80ac			; $8070: 90 3a

+			lda $0369,x		; $8072: bd 69 03
			and #$04				; $8075: 29 04
			beq a_809e			; $8077: f0 25
			lda $03af,x		; $8079: bd af 03
			beq a_809e			; $807c: f0 20
			bmi +			; $807e: 30 0d
			clc				; $8080: 18
			adc $0377,x		; $8081: 7d 77 03
			bcs a_8096			; $8084: b0 10
			cmp $037e,x		; $8086: dd 7e 03
			bcc a_809e			; $8089: 90 13
			bcs a_8096			; $808b: b0 09

+			and #$7f				; $808d: 29 7f
			cmp $0377,x		; $808f: dd 77 03
			beq a_8096			; $8092: f0 02
			bcs a_809e			; $8094: b0 08
a_8096:		lda #$fb				; $8096: a9 fb
			and $0369,x		; $8098: 3d 69 03
			sta $0369,x		; $809b: 9d 69 03
a_809e:		inc $0377,x		; $809e: fe 77 03
			lda $0377,x		; $80a1: bd 77 03
			cmp $037e,x		; $80a4: dd 7e 03
			bne a_80ac			; $80a7: d0 03
			jsr a_8228			; $80a9: 20 28 82
a_80ac:		jsr a_856d			; $80ac: 20 6d 85
			jsr a_85ed			; $80af: 20 ed 85
			jsr a_864a			; $80b2: 20 4a 86
			lda $0369,x		; $80b5: bd 69 03
			bpl +			; $80b8: 10 03
			jsr a_818e			; $80ba: 20 8e 81

+			jsr a_867c			; $80bd: 20 7c 86
			lda $d6			; $80c0: a5 d6
			and #$3f				; $80c2: 29 3f
			sta $d6			; $80c4: 85 d6
			lda $0369,x		; $80c6: bd 69 03
			and #$20				; $80c9: 29 20
			beq a_8103			; $80cb: f0 36
			lda $03c4,x		; $80cd: bd c4 03
			clc				; $80d0: 18
			adc $03cb,x		; $80d1: 7d cb 03
			sta $03cb,x		; $80d4: 9d cb 03
			bcc a_8103			; $80d7: 90 2a
...
a_8103:		inx				; $8103: e8
			...
			cpx #$06				; $8107: e0 06
			bcs a_810e			; $8109: b0 03
			jmp a_8050			; $810b: 4c 50 80

;-------------------------------------------------------------------------------
a_810e:		lda $030a			; $810e: ad 0a 03
			cmp #$30				; $8111: c9 30
			bne +			; $8113: d0 04
			lda #$80				; $8115: a9 80
			bne ++			; $8117: d0 02
...
+			sta $030a			; $811b: 8d 0a 03
			ldy #$03				; $811e: a0 03
			ldx #$0f				; $8120: a2 0f
a_8122:		lda $02ff,x		; $8122: bd ff 02
			sta $3ffd,x		; $8125: 9d fd 3f

			cpx #$08 ; is it noise channel?
			bcc a_8132 ; if not, branch
...
a_AudioOut:
			...
			bmi a_815f			; $8153: 30 0a
_8155:		lda $0302,x		; $8155: bd 02 03
_8158:		and #$07				; $8158: 29 07
			cmp $0312,y		; $815a: d9 12 03
			beq a_8176			; $815d: f0 17

a_815f:		sec				; $815f: 38
			and #$07				; $8160: 29 07
			sta $0312,y		; $8162: 99 12 03
			sta $0302,x		; $8165: 9d 02 03
a_8168:		ora #$f8				; $8168: 09 f8
			sta $4000,x		; $816a: 9d 00 40
a_816d:		lda $0301,x		; $816d: bd 01 03
			sta $3fff,x		; $8170: 9d ff 3f
			jmp a_8186			; $8173: 4c 86 81

;-------------------------------------------------------------------------------
a_8176:		lda $0300,x		; $8176: bd 00 03
			bmi a_8186			; $8179: 30 0b
			and #$20				; $817b: 29 20
			beq a_816d			; $817d: f0 ee
			lda $0302,x		; $817f: bd 02 03
			bpl a_816d			; $8182: 10 e9
			bmi a_815f			; $8184: 30 d9
a_8186:		txa				; $8186: 8a
			sbc #$04				; $8187: e9 04
			tax				; $8189: aa
			dey				; $818a: 88
			bpl a_8122			; $818b: 10 95
			rts				; $818d: 60

;-------------------------------------------------------------------------------
a_818e:		lda $035b,x		; $818e: bd 5b 03
			cmp #$40				; $8191: c9 40
			bcc a_81dd			; $8193: 90 48
			and #$3f				; $8195: 29 3f
			sta $d2			; $8197: 85 d2
			bit $d6			; $8199: 24 d6
			bpl a_81aa			; $819b: 10 0d
...
;-------------------------------------------------------------------------------
a_81aa:		lda $0369,x		; $81aa: bd 69 03
			and #$40				; $81ad: 29 40
			cmp #$40				; $81af: c9 40
			lda $03d9,x		; $81b1: bd d9 03
			beq a_81a9			; $81b4: f0 f3
			bcs a_81be			; $81b6: b0 06
			sec				; $81b8: 38
			sbc $d2			; $81b9: e5 d2
			jmp a_81c1			; $81bb: 4c c1 81

;-------------------------------------------------------------------------------
a_81be:		clc				; $81be: 18
			adc $d2			; $81bf: 65 d2
a_81c1:		beq a_81d3			; $81c1: f0 10
			cmp #$0d				; $81c3: c9 0d
			bcc a_81d1			; $81c5: 90 0a
			cmp #$79				; $81c7: c9 79
			bcs a_81d1			; $81c9: b0 06
			sta $03d9,x		; $81cb: 9d d9 03
			jmp a_854f			; $81ce: 4c 4f 85

;-------------------------------------------------------------------------------
a_81d1:		lda #$00				; $81d1: a9 00
a_81d3:		sta $03d9,x		; $81d3: 9d d9 03
...
-			lsr				; $81e6: 4a
			...
			cmp #$08				; $8206: c9 08
			bcs a_821f			; $8208: b0 15
			rts				; $820a: 60

;-------------------------------------------------------------------------------
a_820b:		lda $03b6,x		; $820b: bd b6 03
			sec				; $820e: 38
			sbc $d2			; $820f: e5 d2
			...
			bcc a_821f			; $821c: 90 01
			rts				; $821e: 60

;-------------------------------------------------------------------------------
a_821f:		lda #$00				; $821f: a9 00
			sta $03b6,x		; $8221: 9d b6 03
			sta $03bd,x		; $8224: 9d bd 03
			rts				; $8227: 60

;-------------------------------------------------------------------------------
a_8228:		lda $034d,x		; $8228: bd 4d 03
			sta $d0			; $822b: 85 d0
...
a_8234:		iny				; $8234: c8
			...
			lda ($d0),y		; $8238: b1 d0
			bmi a_823f			; $823a: 30 03
			jmp a_8486			; $823c: 4c 86 84

;-------------------------------------------------------------------------------
a_823f:		cmp #$b0				; $823f: c9 b0
			bcc a_8246			; $8241: 90 03
			jmp a_8423			; $8243: 4c 23 84

;-------------------------------------------------------------------------------
a_8246:		asl				; $8246: 0a
			tax				; $8247: aa
			lda #>(a_8234-1)				; $8248: a9 82
			pha				; $824a: 48
			lda #<(a_8234-1)				; $824b: a9 33
			pha				; $824d: 48
			lda a_825d+1,x			; $824e: bd 5e 82
			pha				; $8251: 48
			lda a_825d,x			; $8252: bd 5d 82
			pha				; $8255: 48
...
;-------------------------------------------------------------------------------
;	Theoretically those are commands
;	TODO: macro "Addrm1" (Address minus one)
a_825d:
			.addr (a_829f-1)
			.addr (a_82aa-1)
			.addr (a_82cb-1)
...
;-------------------------------------------------------------------------------
a_82c5:		lda $03a8,x		; $82c5: bd a8 03
			sta $0300			; $82c8: 8d 00 03
a_82cb:		lda #$00				; $82cb: a9 00
			sta $031c,x		; $82cd: 9d 1c 03
a_82d0:		pla				; $82d0: 68
			pla				; $82d1: 68
			pla				; $82d2: 68
			pla				; $82d3: 68
			jmp a_8103			; $82d4: 4c 03 81

;-------------------------------------------------------------------------------
a_82d7:		sta $0331,x		; $82d7: 9d 31 03
			rts				; $82da: 60

;-------------------------------------------------------------------------------
a_82db:		sta $032a,x		; $82db: 9d 2a 03
			rts				; $82de: 60

;-------------------------------------------------------------------------------
a_82df:		beq +			; $82df: f0 04
			clc				; $82e1: 18
...
;-------------------------------------------------------------------------------
a_82e9:		sta $031c,x		; $82e9: 9d 1c 03
			rts				; $82ec: 60

;-------------------------------------------------------------------------------
a_82ed:		sta $d3			; $82ed: 85 d3
			...
			bpl +			; $82f9: 10 08
			adc $d2			; $82fb: 65 d2
			bcs a_830b			; $82fd: b0 0c
			lda #$00				; $82ff: a9 00
			beq a_830b			; $8301: f0 08

+			adc $d2			; $8303: 65 d2
			cmp #$10				; $8305: c9 10
			bcc a_830b			; $8307: 90 02
			lda #$0f				; $8309: a9 0f
a_830b:		sta $d2			; $830b: 85 d2
			lda $0323,x		; $830d: bd 23 03
			and #$f0				; $8310: 29 f0
a_8312:		ora $d2			; $8312: 05 d2
			sta $0323,x		; $8314: 9d 23 03
			rts				; $8317: 60

;-------------------------------------------------------------------------------
a_8318:		sta $d2			; $8318: 85 d2
			lda $0323,x		; $831a: bd 23 03
			and #$0f				; $831d: 29 0f
			bpl a_8312			; $831f: 10 f1
a_8321:		beq a_8337			; $8321: f0 14
...
;-------------------------------------------------------------------------------
a_8337:		lda $0370,x		; $8337: bd 70 03
			and #$fe				; $833a: 29 fe
			sta $0370,x		; $833c: 9d 70 03
			rts				; $833f: 60

;-------------------------------------------------------------------------------
a_8340:		ora $0300			; $8340: 0d 00 03
			sta $0300			; $8343: 8d 00 03
			rts				; $8346: 60

;-------------------------------------------------------------------------------
a_8347:		sta $d2			; $8347: 85 d2
			and #$3f				; $8349: 29 3f
...
;-------------------------------------------------------------------------------
a_8374:		lda $0369,x		; $8374: bd 69 03
			and #$02				; $8377: 29 02
			bne a_8380			; $8379: d0 05
a_837b:		lda ($d0),y		; $837b: b1 d0
			jmp a_829f			; $837d: 4c 9f 82
...
;-------------------------------------------------------------------------------
a_8382:		lda $0370,x		; $8382: bd 70 03
			and #$04				; $8385: 29 04
			bne a_837b			; $8387: d0 f2
			iny				; $8389: c8
			rts				; $838a: 60

;-------------------------------------------------------------------------------
a_838b:		sbc $038c,x		; $838b: fd 8c 03
			pha				; $838e: 48
			iny				; $838f: c8
			lda ($d0),y		; $8390: b1 d0
			sta $d2			; $8392: 85 d2
			...
			pla				; $839b: 68
			tay				; $839c: a8
			jmp a_83ad			; $839d: 4c ad 83

;-------------------------------------------------------------------------------
a_83a0:		sta $d2			; $83a0: 85 d2
			iny				; $83a2: c8
			lda ($d0),y		; $83a3: b1 d0
			sta $d3			; $83a5: 85 d3
			sty $d7			; $83a7: 84 d7
...
;-------------------------------------------------------------------------------
a_83b9:		sta $033f,x		; $83b9: 9d 3f 03
			rts				; $83bc: 60

;-------------------------------------------------------------------------------
a_83bd:		sta $03e0,x		; $83bd: 9d e0 03
			rts				; $83c0: 60

;-------------------------------------------------------------------------------
a_83c1:		sta $d2			; $83c1: 85 d2
			asl				; $83c3: 0a
			beq a_83dc			; $83c4: f0 16
...
;-------------------------------------------------------------------------------
a_83e6:		bmi +			; $83e6: 30 0e
			beq a_8404			; $83e8: f0 1a
...
;-------------------------------------------------------------------------------
a_8404:		lda $0369,x		; $8404: bd 69 03
			and #$7f				; $8407: 29 7f
			sta $0369,x		; $8409: 9d 69 03
			rts				; $840c: 60

;-------------------------------------------------------------------------------
a_840d:		lda $031c,x		; $840d: bd 1c 03
			eor #$10				; $8410: 49 10
...
;-------------------------------------------------------------------------------
a_8417:		sta $0346,x		; $8417: 9d 46 03
			rts				; $841a: 60

;-------------------------------------------------------------------------------
a_841b:		sta $03af,x		; $841b: 9d af 03
			rts				; $841e: 60

;-------------------------------------------------------------------------------
a_841f:		sta $0362,x		; $841f: 9d 62 03
			rts				; $8422: 60

;-------------------------------------------------------------------------------
a_8423:		cmp #$e0				; $8423: c9 e0
			bcs a_847f			; $8425: b0 58
			sbc #$bf				; $8427: e9 bf
			bcc a_847f			; $8429: 90 54
			asl				; $842b: 0a
			asl				; $842c: 0a
			sty $d7			; $842d: 84 d7
			tay				; $842f: a8
			lda a_8917,y			; $8430: b9 17 89
			sta $032a,x		; $8433: 9d 2a 03
			lda a_8919,y			; $8436: b9 19 89
			and #$1f				; $8439: 29 1f
			cmp #$10				; $843b: c9 10
			bcc +			; $843d: 90 02
			adc #$6f				; $843f: 69 6f
...
+			sta $03e7,x		; $8441: 9d e7 03
			...
			lda a_8918,y			; $845a: b9 18 89
			plp				; $845d: 28
			bmi a_846d			; $845e: 30 0d
			pha				; $8460: 48
			lda $0369,x		; $8461: bd 69 03
			and #$7f				; $8464: 29 7f
			sta $0369,x		; $8466: 9d 69 03
			pla				; $8469: 68
			jmp a_8474			; $846a: 4c 74 84

;-------------------------------------------------------------------------------
a_846d:		and #$ff				; $846d: 29 ff
			jsr a_83e6			; $846f: 20 e6 83
			lda #$00				; $8472: a9 00
a_8474:		sta $0331,x		; $8474: 9d 31 03
			lda a_891a,y			; $8477: b9 1a 89
			ldy $d7			; $847a: a4 d7
			jmp a_8486			; $847c: 4c 86 84

;-------------------------------------------------------------------------------
a_847f:		lda $03a1,x		; $847f: bd a1 03
			php				; $8482: 08
			jmp a_8492			; $8483: 4c 92 84
...
a_8492:		jsr a_851c			; $8492: 20 1c 85
			lda ($d0),y		; $8495: b1 d0
			cmp #$e0				; $8497: c9 e0
			bcs a_84a1			; $8499: b0 06
			lda $039a,x		; $849b: bd 9a 03
			jmp a_84b5			; $849e: 4c b5 84

;-------------------------------------------------------------------------------
a_84a1:		sec				; $84a1: 38
			sbc #$e0				; $84a2: e9 e0
			bne a_84ac			; $84a4: d0 06
			iny				; $84a6: c8
			lda ($d0),y		; $84a7: b1 d0
			jmp a_84b4			; $84a9: 4c b4 84

;-------------------------------------------------------------------------------
a_84ac:		sty $d2			; $84ac: 84 d2
			tay				; $84ae: a8
			lda a_8908,y			; $84af: b9 08 89
			ldy $d2			; $84b2: a4 d2
a_84b4:		iny				; $84b4: c8
a_84b5:		sta $037e,x		; $84b5: 9d 7e 03
...
a_84d8:		lda $0370,x		; $84d8: bd 70 03
			...
			tya				; $84f8: 98
			pha				; $84f9: 48
			lda a_8867,x			; $84fa: bd 67 88
			jsr a_LoadSoundAddress			; $84fd: 20 4f 87
			pla				; $8500: 68
			tay				; $8501: a8
...
;-------------------------------------------------------------------------------
a_851c:		sta $03b6,x		; $851c: 9d b6 03
			and #$ff				; $851f: 29 ff
			bne a_8527			; $8521: d0 04
			sta $03bd,x		; $8523: 9d bd 03
			rts				; $8526: 60

;-------------------------------------------------------------------------------
a_8527:		lda $031c,x		; $8527: bd 1c 03
			and #$08				; $852a: 29 08
			beq a_8546			; $852c: f0 18
			lda #$01				; $852e: a9 01
...
;-------------------------------------------------------------------------------
a_8546:		lda $03b6,x		; $8546: bd b6 03
			clc				; $8549: 18
...
a_854f:		asl				; $854f: 0a
			...
			clc				; $8555: 18
			php				; $8556: 08
			adc a_880e,y			; $8557: 79 0e 88
			sta $03b6,x		; $855a: 9d b6 03
			lda a_880f,y			; $855d: b9 0f 88
			adc #$00				; $8560: 69 00
			plp				; $8562: 28
			bpl +			; $8563: 10 02
			sbc #$00				; $8565: e9 00
...
;-------------------------------------------------------------------------------
a_856d:		lda $032a,x		; $856d: bd 2a 03
			beq a_85a4			; $8570: f0 32
			asl				; $8572: 0a
			tay				; $8573: a8
			lda a_896e,y			; $8574: b9 6e 89
			sta $d2			; $8577: 85 d2
			lda a_896e+1,y			; $8579: b9 6f 89
			sta $d3			; $857c: 85 d3
			ldy $03ee,x		; $857e: bc ee 03
			jsr a_85ab			; $8581: 20 ab 85
			iny				; $8584: c8
			sta $d2			; $8585: 85 d2
...
;-------------------------------------------------------------------------------
a_85a4:		lda $0323,x		; $85a4: bd 23 03
			sta $0317			; $85a7: 8d 17 03
			rts				; $85aa: 60

;-------------------------------------------------------------------------------
a_85ab:		lda ($d2),y		; $85ab: b1 d2
			bmi a_85b0			; $85ad: 30 01
			rts				; $85af: 60

;-------------------------------------------------------------------------------
a_85b0:		cmp #$80				; $85b0: c9 80
			bne a_85b8			; $85b2: d0 04
a_85b4:		dey				; $85b4: 88
			lda ($d2),y		; $85b5: b1 d2
			rts				; $85b7: 60

;-------------------------------------------------------------------------------
a_85b8:		cmp #$81				; $85b8: c9 81
			bne a_85c5			; $85ba: d0 09
a_85bc:		tya				; $85bc: 98
			iny				; $85bd: c8
			sec				; $85be: 38
			sbc ($d2),y		; $85bf: f1 d2
...
;-------------------------------------------------------------------------------
a_85c5:		cmp #$82				; $85c5: c9 82
			bne a_85ce			; $85c7: d0 05
			ldy #$00				; $85c9: a0 00
			lda ($d2),y		; $85cb: b1 d2
			rts				; $85cd: 60

;-------------------------------------------------------------------------------
a_85ce:		cmp #$83				; $85ce: c9 83
			bne a_85dd			; $85d0: d0 0b
			lda $0369,x		; $85d2: bd 69 03
			and #$04				; $85d5: 29 04
			bne a_85b4			; $85d7: d0 db
			iny				; $85d9: c8
			lda ($d2),y		; $85da: b1 d2
a_85dc:		rts				; $85dc: 60

;-------------------------------------------------------------------------------
a_85dd:		cmp #$84				; $85dd: c9 84
			bne a_85dc			; $85df: d0 fb
			lda $0369,x		; $85e1: bd 69 03
			and #$04				; $85e4: 29 04
			bne a_85bc			; $85e6: d0 d4
			iny				; $85e8: c8
			iny				; $85e9: c8
			lda ($d2),y		; $85ea: b1 d2
			rts				; $85ec: 60
...
;-------------------------------------------------------------------------------
a_85ed:		lda $03b6,x		; $85ed: bd b6 03
			ora $03bd,x		; $85f0: 1d bd 03
			beq a_8649			; $85f3: f0 54
			lda $0331,x		; $85f5: bd 31 03
			bmi a_8649			; $85f8: 30 4f
			and #$1f				; $85fa: 29 1f
			asl				; $85fc: 0a
			beq a_8649			; $85fd: f0 4a
			tay				; $85ff: a8
			lda a_891d,y			; $8600: b9 1d 89
			sta $d2			; $8603: 85 d2
			lda a_891d+1,y			; $8605: b9 1e 89
			sta $d3			; $8608: 85 d3
			ldy $03f5,x		; $860a: bc f5 03
			jsr a_85ab			; $860d: 20 ab 85
			iny				; $8610: c8
			sta $d5			; $8611: 85 d5
			tya				; $8613: 98
			...
			clc				; $8617: 18
			lda $d5			; $8618: a5 d5
			beq a_8649			; $861a: f0 2d
			bpl a_8627			; $861c: 10 09
			adc $03b6,x		; $861e: 7d b6 03
			bcs a_8638			; $8621: b0 15
			ldy #$00				; $8623: a0 00
			beq a_862e			; $8625: f0 07
a_8627:		adc $03b6,x		; $8627: 7d b6 03
			bcc a_8638			; $862a: 90 0c
			ldy #$ff				; $862c: a0 ff
a_862e:		pha				; $862e: 48
			lda $0331,x		; $862f: bd 31 03
			and #$40				; $8632: 29 40
			beq a_863c			; $8634: f0 06
			pla				; $8636: 68
			tya				; $8637: 98
a_8638:		sta $03b6,x		; $8638: 9d b6 03
			rts				; $863b: 60
...
;-------------------------------------------------------------------------------
a_864a:		lda $031c,x		; $864a: bd 1c 03
			and #$02				; $864d: 29 02
			beq +			; $864f: f0 13
...
;-------------------------------------------------------------------------------
a_867c:		lda $031c,x		; $867c: bd 1c 03
			and #$20				; $867f: 29 20
			beq +			; $8681: f0 03
			jsr a_8665			; $8683: 20 65 86

+			lda $0370,x		; $8686: bd 70 03
			and #$02				; $8689: 29 02
			bne a_867b			; $868b: d0 ee
			...
			bne a_86a1			; $8699: d0 06
			lda #$30				; $869b: a9 30
			sta $0302,y		; $869d: 99 02 03
			rts				; $86a0: 60

;-------------------------------------------------------------------------------
a_86a1:		lda $031c,x		; $86a1: bd 1c 03
			and #$0a				; $86a4: 29 0a
			beq a_86b8			; $86a6: f0 10
			cmp #$02				; $86a8: c9 02
			bne a_86c9			; $86aa: d0 1d
			lda $0317			; $86ac: ad 17 03
			sta $030e			; $86af: 8d 0e 03
			lda $03e7,x		; $86b2: bd e7 03
			sta $0310			; $86b5: 8d 10 03
a_86b8:		lda $031c,x		; $86b8: bd 1c 03
			and #$01				; $86bb: 29 01
			beq a_86df			; $86bd: f0 20
			cpy #$08				; $86bf: c0 08
			bcs a_86c9			; $86c1: b0 06
			lda $0331,x		; $86c3: bd 31 03
			sta $0303,y		; $86c6: 99 03 03
a_86c9:		lda $0317			; $86c9: ad 17 03
...
a_PlaySound:
			...
			pha				; $8735: 48
			lda $d2			; $8736: a5 d2
			jsr a_SetupPitchVolume			; $8738: 20 45 87
			lda #$00				; $873b: a9 00
...
a_LoadSoundAddress:
			...
			asl				; $8751: 0a
			tax				; $8752: aa
			lda SoundTable,x			; $8753: bd 87 8b
			sta $d2			; $8756: 85 d2
			lda SoundTable+1,x			; $8758: bd 88 8b
			sta $d3			; $875b: 85 d3
			ldy #$00				; $875d: a0 00
			lda ($d2),y		; $875f: b1 d2
			bne a_8793			; $8761: d0 30
			lda $d3			; $8763: a5 d3
			pha				; $8765: 48
			lda $d2			; $8766: a5 d2
			pha				; $8768: 48
...
;-------------------------------------------------------------------------------
a_876a:		sta $031c,x		; $876a: 9d 1c 03
			iny				; $876d: c8
			jmp a_8820			; $876e: 4c 20 88
...
a_8793:		iny				; $8793: c8
			sta $d5			; $8794: 85 d5
a_8796:		lda ($d2),y		; $8796: b1 d2
			iny				; $8798: c8
			tax				; $8799: aa
			lda ($d2),y		; $879a: b1 d2
			beq a_876a			; $879c: f0 cc
			lda $031c,x		; $879e: bd 1c 03
			and #$40				; $87a1: 29 40
			bne a_8769			; $87a3: d0 c4
			...
			bne a_87d0			; $87c2: d0 0c
			lda $031c,x		; $87c4: bd 1c 03
			beq a_87d3			; $87c7: f0 0a
			lda #$04				; $87c9: a9 04
			sta $0370,x		; $87cb: 9d 70 03
			bne a_87d3			; $87ce: d0 03
a_87d0:		sta $03a8,x		; $87d0: 9d a8 03
a_87d3:		txa				; $87d3: 8a
			pha				; $87d4: 48
			lda #$09				; $87d5: a9 09
			sta $d4			; $87d7: 85 d4
...
a_880e:		.byte $03	; $880e: 03		Suspected data
a_880f:		lda $03a8,x		; $880f: bd a8 03
			sta $d4			; $8812: 85 d4
			lda #$01				; $8814: a9 01
...
a_8820:		dec $d5			; $8820: c6 d5
			beq a_8827			; $8822: f0 03
			jmp a_8796			; $8824: 4c 96 87
...
a_8867:		.byte $01, $42, $01, $30	; $8867: 01 42 01 30	 Data
...
;-------------------------------------------------------------------------------
a_8900:		lda #$03				; $8900: a9 03
			sta $d6			; $8902: 85 d6
			rts				; $8904: 60

;-------------------------------------------------------------------------------
a_8905:		lda #$01				; $8905: a9 01
			.byte $d0	; $8907: d0		Suspected data
a_8908:		sbc $0201,y		; $8908: f9 01 02

;-------------------------------------------------------------------------------
			.byte $03, $04, $06, $08	; $890b: 03 04 06 08	 Data
			.byte $09, $0c, $10, $12	; $890f: 09 0c 10 12	 Data
			.byte $18, $20, $24, $30	; $8913: 18 20 24 30	 Data
a_8917:		.byte $03	; $8917: 03			Data
a_8918:		.byte $00	; $8918: 00			Data
a_8919:		.byte $49	; $8919: 49			Data
a_891a:		.byte $19, $0e, $00	; $891a: 19 0e 00		Data
	;TODO: table
a_891d:		.byte $47	; $891d: 47			Data
...
;-------------------------------------------------------------------------------
MUS_SetVoice .function id
			.byte $88, id
	.endf

;	These 2 may need better names...
MUS_Loop .function address
			.byte $81, $70
			.addr address
	.endf
MUS_Jump .function address
			.byte $80
			.addr address
	.endf

MUS_HeaderStart .function end
			.byte (end-*-1)/10
	.endf
...
Music_Empty:
			MUS_HeaderStart _ChannelListEnd
			.byte $06, $01, $3f, $00
...
-
			...
			MUS_SetVoice $04	; $8cb0: 54 8c 88 04	 Data
...
+
			...
			.byte $83, $40
			MUS_SetVoice $04	; $8d50: 83 40 88 04	 Data
